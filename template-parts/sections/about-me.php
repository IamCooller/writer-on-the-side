    ...
    <div class="relative py-6 sm:py-8">
        ...
        <div class="flex items-center justify-center max-lg:flex-col">
            ...
            <div class="flex-shrink-0 flex flex-col items-center text-center">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/people-faces-8.png" alt="Hassan Osman"
            ...
            <div
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/arrow-2.png"
                    class="w-[120px] sm:w-[161px] aspect-square max-lg:hidden" alt="arrow pointing to work history" />
            </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logos/1.png"
                                alt="The Wall Street Journal" class="h-5 sm:h-6 md:h-8 lg:h-[41px] object-contain" />
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logos/2.png" alt="Forbes"
                                class="h-5 sm:h-6 md:h-8 lg:h-[51px] object-contain" />
                            ...
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logos/9.png" alt="Success"
                                class="h-5 sm:h-6 md:h-8 lg:h-[48px] object-contain" />
                        </div>
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-3 gap-x-1 sm:gap-x-2 md:gap-x-[55px] gap-y-3 place-items-center">
                            ...
                            <div class="flex flex-col justify-center items-center text-center">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logos/10.png" alt="EY"
                                    class="h-[76px] lg:h-[132px] object-contain " />
